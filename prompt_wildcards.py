...
class PromptWildcards:
    ...
    def generate_pm(self, Prompt: str, seed: int = None) -> Tuple[str]:
        ...
        files = {tag: os.path.join(os.path.dirname(__file__), "data", f"{name}.csv") for tag, name in {
            ...
            "<pass>": "passwords", "<word>": "words", "<wordp>": "power_words", "<wordn>": "power_words_nsfw", "<wordk>": "keywords", "<color>": "colors","<color2>": "color2","<medi>": "mediums","<light>":"lighting","<light2>":"lighting2","<style>":"styles","<style2>":"styles2","<artist>":"artists","<painter>":"artist_styles","<paintstyle>":"painting_styles"}.items()}
